...
public class ShapeDraw extends JPanel implements MouseListener, MouseMotionListener {
	static ArrayList<Drawable> itemsDrawn;
	public JButton clear, undo,save,open;
	private JLabel mousePos;
	public ShapeDraw.DrawPanel dp = new DrawPanel();
	public ShapeDraw.ControlPanel cp = new ControlPanel(dp);
			...
			public void actionPerformed(ActionEvent arg0) {
                ...
                open.addActionListener(new ActionListener(){
                    public void actionPerformed(ActionEvent arg0){
                                ...
                                try{
                                    String fileName = "G:\\java\\ShapeDraw\\pic.jpeg";
                ...
                save.addActionListener(new ActionListener(){
                    public void actionPerformed(ActionEvent arg0){
                                ...
                                try{
                                    ...
                                    dp.paint(graphics2D);
                                    ImageIO.write(image,"jpeg", new File("G:\\java\\ShapeDraw\\pic.jpeg"));
                                }
                                catch(Exception exception){
	...
	public static void main(String[] args) {
		// here Creating the frame.
		JFrame frame = new JFrame("SHAPE Application");
		// Optional: What happens when the frame closes?
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		// here Creating components and put them in the frame.
		final ShapeDraw drawing = new ShapeDraw();
